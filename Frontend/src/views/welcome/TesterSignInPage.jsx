...
class TesterSignInPage extends React.Component {
    constructor(props) {
        super(props);
            ...
            <>
                <Form>
                    <div className="modal-header">
                        ...
                        <Input outline id="FormInputGroup" placeholder="Tester Name" type="text" />
                        <UncontrolledDropdown setActiveFromChild>
                            ...
                            <DropdownMenu>
                                {["A", "B", "C", "D"].map(
                                    (e, key) => {
                                        return <DropdownItem key={key} tag="a" href="/blah">
                                            Group {e}
                                        </DropdownItem>
                                    }
                                )}
...
const connectedTesterSignInPage = connect(mapStateToProps,mapDispatchToProps(alertActions))(TesterSignInPage);
export { connectedTesterSignInPage as TesterSignInPage };